...
func CreateConnection() *sql.DB {
	...
	fmt.Println("Successfully created connection with POSTGRES")
...
func UpdateStock(w http.ResponseWriter, r *http.Request) {
	...
	msg := fmt.Sprintf("Stock update successfully. Total rows/records affected: %v", updatedRows)
	res := response{
		ID:      int64(id),
		Message: msg,
	}
...
func getStock(id int64) (models.Stock, error) {
	...
	queryString := "SELECT * FROM STOCKS WHERE stockid = $1"
...
func getAllStock() ([]models.Stock, error) {
	...
	queryString := "SELECT * FROM STOCKS"
